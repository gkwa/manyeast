Our development standards mandate that individual code files strive to remain under {{ .LineCountPerFile }} lines, while recognizing that justified outliers may occasionally be warranted.
